...
public class Datasource {
    ...
    /* Use to retrieve the instance of the Datasource object.  */
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        try (Statement statement = conn.createStatement();
            ...
            while (results.next()) {
                try {
                    /* Add an artist every 0.02 seconds.  */
                    Thread.sleep(20);
                }
    ...
    /* Find the album based on ID of artist.  */
    ...
    public boolean updateArtistName(int id, String newName) {
        try {
            ...
            /* Since I am updating a single record, it should return 1.  */
            int affectedRecords = updateArtistName.executeUpdate();

            /* If affectedRecords is 1, return true, otherwise, return false.  */
